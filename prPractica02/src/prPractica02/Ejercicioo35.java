...
public class Ejercicioo35 {
	...
	public static void main(String[] args) {
		...
		int numA,numB,numAB,factorialA=1,factorialB=1,factorialAB=1,resultado;
		...
		if (numA>=numB && numA>=0 && numB>=0) {
			...
			for (int cont=numA;cont>0;cont--) {
				factorialA=factorialA*cont;
			}
			
			for (int cont=numB;cont>0;cont--) {
				factorialB=factorialB*cont;
			}
			
			numAB=numA-numB;
			
			for (int cont=numAB;cont>0;cont--) {
