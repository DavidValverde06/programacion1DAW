...
public class MismosParesImpares {
	// Variables de instancia
	private int numero;
	private int contPares;
	private int contImpares;
	// Constructor
	public MismosParesImpares(int num){
		this.numero = num;
		contPares=0;
		contImpares=0;
	}
	...
	public static void main(String[] args) {
		MismosParesImpares ob = new MismosParesImpares(Integer.parseInt(args[0]));
		ob.cuentaDivisores();
		...
		for (int i=1; i<=100; i++){
			MismosParesImpares ob2 = new MismosParesImpares(i);
			ob2.cuentaDivisores();
