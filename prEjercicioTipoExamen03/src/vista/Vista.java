...
public class Vista extends JPanel {
	 ...
	 */
	private JComboBox<EnumUbicaciones> cbUbicaciones;
	...
	private JPanel preparaPanelDatosReserva() {
		...
		// Cargar las ubicaciones, que lo podéis hacer en la propia Vista.
		cbUbicaciones = new JComboBox<>(EnumUbicaciones.values());  // FALTA SU CREACIÓN CON LAS UBICACIONES DE LA ENUMERACIÓN
	 ...
	 * Métodos getters
	 */
	public JComboBox<EnumUbicaciones> getCbUbicaciones() {return cbUbicaciones;}
