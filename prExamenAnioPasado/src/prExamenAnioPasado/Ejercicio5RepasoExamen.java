 ...
 * 		Solicitar al usuario las temperaturas día por día.
		...
		Calcular y mostrar:
			...
			Mostrar una advertencia si hay más de 5 días de ola de calor consecutivos. OPCIONAL
 */
...
public class Ejercicio5RepasoExamen {
	...
	public static void main(String[] args) {
		...
		final int DIAS=30;
		int contDias=1,temperatura,temperaturaMedia=0,temperaturaMax,temperaturaMin,contDiasOlaCalor=0,contDiasFrios=0;
