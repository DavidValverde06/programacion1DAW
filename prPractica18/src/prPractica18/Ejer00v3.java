...
public class Ejer00v3 extends JFrame {
	...
	public Ejer00v3() {
		...
		bSi.addFocusListener(cb);

	}

	public static void main(String[] args) {

		Ejer00v3 ventana = new Ejer00v3();
	 ...
	 */
	class ControlBoton implements ActionListener, FocusListener {
		...
		public void focusGained(FocusEvent e) {
			// bSi.setBackground(Color.GREEN);
			e.getComponent().setBackground(Color.ORANGE);
		}

		@Override
		public void focusLost(FocusEvent e) {
			bSi.setBackground(Color.YELLOW);
		}
	}
