...
public class O4_OperacionesTablaBancoV2Parametrizada {
	...
	public static void cargaTablaBanco(Connection con, String BDNombre) {
		...
		try (Scanner sc = new Scanner(Path.of("./datos.txt"), StandardCharsets.UTF_8)) { // try con recursos
		   ...
		   do {
			   ...
			   try (PreparedStatement ps = con.prepareStatement(sqlString)) { // try con recursos
