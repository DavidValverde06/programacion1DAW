 ...
 * premiso de lectura, si es un directorio o si está oculto. Cuando se trate de un directorio pondremos el
 * JComboBox en color verde, y cuando se trate de un fichero en color naranja.
 */
